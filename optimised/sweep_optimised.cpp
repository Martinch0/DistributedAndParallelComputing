/////////////////////////////////////////////////////////////////////////////
// 
//  MAIN CPP SOURCE FOR OPTIMISED IMPLEMENTATION OF TORUS ROTATION
//  DISTRIBUTED AND PARALLEL COMPUTATION MINIPROJECT
//  2014-2015
//  
//  This is the main cpp code for the optimised device implementation of torus rotation.
...
float* d_out1;  // The points of the generated torus.
float* d_out2;  // The points of the generated torus.
...
void display()
{
  ...
  if ( currentTime - lastTime >= 1000 ){
    ...
    snprintf(buffer, 32, "Optimised Torus - FPS: %f", nbFrames);
